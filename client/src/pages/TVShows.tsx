...
const TVShows = () => {
  ...
  const load = (refresh=false)=> getTVFeed(refresh).then(d => { setCollection(d.collection||[]); setWatchlist(d.watchlist||[]); setRecent(d.recent||[]); setLists(d.lists||[]) }).finally(()=> setLoading(false))
